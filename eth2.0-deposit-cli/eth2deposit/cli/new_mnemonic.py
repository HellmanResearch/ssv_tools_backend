...
# )
@generate_keys_arguments_decorator
def new_mnemonic(ctx: click.Context, mnemonic_language: str = "english", **kwargs: Any) -> None:
    mnemonic_language = "english"
    print("in new_mnemonic")
    mnemonic = get_mnemonic(language=mnemonic_language, words_path=WORD_LISTS_PATH)
    # test_mnemonic = ''
    # while mnemonic != test_mnemonic:
    #     click.clear()
    #     click.echo(
    #         'This is your seed phrase. Write it down and store it safely, it is the ONLY way to retrieve your deposit.')  # noqa: E501
    #     click.echo('\n\n%s\n\n' % mnemonic)
